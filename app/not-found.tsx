...
export const metadata = {
  title: "Page Not Found | Hill + Delamain",
};
  ...
  return (
    ...
    >
      <div className="max-w-xl w-full">
        ...
        >
          The page you&apos;re looking for doesn&apos;t exist or may have been moved. Try heading back to the homepage or exploring our services.
        </p>
