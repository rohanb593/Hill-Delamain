...
export const metadata = {
  ...
  description:
    "ZRA-compliant customs broking in Zambia. 53 ASYCUDA profiles, ZMW 250M bond management. Expert HS classification, duty rebates, and post-clearance audit support.",
  keywords: [
...
export default function CustomsBrokingPage() {
  return (
    <ServicePageLayout
      ...
      description="With 53 active ASYCUDA profiles and a ZMW 250M bond under management, Hill + Delamain is one of Zambia's most capable customs broking operations. Our team delivers accurate HS classification, timely duty rebates, and full post-clearance audit support."
      accent="oklch(0.37 0.23 265)"
      features={[
        { title: "ZRA Compliance", body: "Fully ZRA-accredited with 53 ASYCUDA World profiles covering all major commodity groups and trade corridors." },
      ...
      badge="ZCFAA Member · 53 ASYCUDA Profiles · ZMW 250M Bond · TAZ Member · ZCILT Member"
