  ...
  return (
    <ServicePageLayout
      ...
      features={[
        ...
        { title: "Cross-Border Corridors", body: "Border posts covered include Chirundu, Kasumbalesa, Nakonde, Kazungula, Chanida, Mwami, Kipushi, Chembe Ferry, Katima Mulilo and Wenela — full regional reach across southern and central Africa." },
